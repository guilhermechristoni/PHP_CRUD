...
if (isset($_POST['submit'])) {
    ...
    $result_clientes = mysqli_query($mysqli, "INSERT INTO table_clientes(cpf,cidade,endereco_rua,email,data_nasc) VALUES ('$cpf','$nome','$cidade','$endereco_rua','$email','$data_nasc')");
    $result_reserva = mysqli_query($mysqli, "INSERT INTO table_reserva(cpf,nome,horario,data) VALUES ('$cpf','$horario','$data')");
}
